...
public class ModelMovies implements Parcelable {
    ...
    public ModelMovies(@NonNull String id, String title, String releaseDate, String voteAverage,
    ...
    public ModelMovies(Parcel parcel) {
    ...
    public static final Parcelable.Creator<ModelMovies> CREATOR = new
            Parcelable.Creator<ModelMovies>() {
                @Override
